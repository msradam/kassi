...
SLIDES = [
    ...
    {  # 3. WHAT IT DOES (architecture)
        ...
        "body": [
            ...
            "(model-agnostic: a local 8B or a frontier model, the same harness drives either):",
            "",
            ...
            "→   the model writes the cited analysis + fix, an audit pass screens it, sealed to the ledger",
        ],
    },
    {  # 4. LIVE DEMO
        "kicker": "LIVE  ·  NOTHING CANNED",
        "title": "Watch it run.",
        "accent": "Real app, real k6, the official Splunk MCP Server, the model in the loop.",
        "body": ["Two changes, two different failure signatures. Same agent, same dashboard."],
    },
    {  # 5. SCORECARD
        "kicker": "VALIDATION  ·  GROUND TRUTH, NOT A DEMO",
        "title": "It's measured.",
        "title_size": 60,
        "accent": "Reproducible end to end. Each suite found real bugs.",
        "body": [
            "kassi-bench  ·  80 live runs, model authors the test, verdict computed from Splunk",
            "      faults: 90% detect / 92% localize / 95% root cause      controls: 0% false alarm",
            "",
            "RCAEval RE3  ·  the academic RCA benchmark (Online Boutique, Train Ticket)",
            "      root cause at top-1: 81% · top-3: 100%      published baselines ~30-60%",
            "",
            "go-httpbin  ·  a third-party app it never instrumented:   15 / 15",
        ],
    },
    {  # 5. THANK YOU
